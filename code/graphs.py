...
def distance_comparison_figure(ax,distances_x,distances_y,geom_medians_x,geom_medians_y,avg_pairwise_x,avg_pairwise_y,gene_list,ylim='default'):


    mean1 = np.mean(distances_x)
    mean6 = np.mean(distances_y)
